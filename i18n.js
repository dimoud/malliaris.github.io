...
(function () {
    ...
    const t = {
        ...
        'faq.more': { el: 'Περισσότερα στους οδηγούς μας: ώρες Τεχνικού Ασφαλείας, έλεγχος της Επιθεώρησης Εργασίας, εργατικό ατύχημα', en: 'More in our guides: safety technician hours, Labour Inspectorate inspections, workplace accidents' },
        ...
        'fn.guides':   { el: 'Οδηγοί', en: 'Guides' },
        'fn.calc':     { el: 'Υπολογιστής ωρών Τεχνικού Ασφαλείας', en: 'Safety technician hours calculator' },
